...
def generate_6mer_bed(bam_file):
	"""
...
if __name__ == "__main__":
	...
	parser.add_argument("genome", help="The sorted, indexed FASTA file containing the genome sequence")
	...
	shuf_bg_6mers = bg_6mers.shuffle(genome='hg19', chrom=True, noOverlapping=True, excl=peaks.fn)
